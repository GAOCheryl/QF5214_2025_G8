...
END_DATE = datetime(2025, 3, 1)    # Adjust as needed

nasdaq_companies = ["ADBE", "AMD", "ABNB", "GOOGL"]
MINIMUM_TWEETS = 6  # Adjust as needed
...
async def main():
    ...
    # -------------------------------------
    with open('tweets_nasdaq100_1.csv', 'w', newline='', encoding='utf-8-sig') as csv_file:
