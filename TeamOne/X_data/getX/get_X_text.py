...
# Prompt the user (synchronously)
# config_path = input("Enter the path to your config.ini file (default: config.ini): ") or "config.ini"    # Mount it inside the container
csv_filename = input("Enter the CSV filename strictly in the form: tweets_nasdaq100_4.csv: ")         # no need for quotes

# nasdaq_companies = ["APP", "ARM", "ASML", "AZN"]    #Need change
