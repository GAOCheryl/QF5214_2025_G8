...
class SequenceModel():
    ...
    def fit(self, dl_train, dl_valid=None):
        ...
        for step in range(self.n_epochs):
            ...
            #    predictions, metrics = self.predict(dl_valid)
                predictions, metrics, real_returns, real_prices, market_cap = self.predict(dl_valid)
    ...
    def predict(self, dl_test):
        ...
        for data in test_loader:
            ...
            ######  2
            price = data[:, -1, 3]  # 第4个 feature 是价格, close price 
            market = data[:, -1, 5]  # 第7个 feature 是market cap
            ######
